...
net.Receive("RdmtDeadGiftBegin", function()
    ...
    hook.Add("HUDPaint", "RdmtDeadGiftUI", function()
        ...
        local progress = Randomat.Client:GetNWInt("RdmtDeadGiftPower", 0)
        ...
        local target = Randomat.Client:GetObserverMode() ~= OBS_MODE_ROAMING and Randomat.Client:GetObserverTarget() or nil
