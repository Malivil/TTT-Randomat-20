net.Receive("FogOfWarBegin", function()
        ...
        hook.Add("SetupWorldFog", "FogOfWarWorldFog", function()
        ...
        hook.Add("SetupSkyboxFog", "FogOfWarSkyboxFog", function(scale)
            render.FogMode(MATERIAL_FOG_LINEAR)
            render.FogColor(0, 0, 0)
            render.FogMaxDensity(1)
...
net.Receive("FogOfWarEnd", function()
    hook.Remove("SetupWorldFog", "FogOfWarWorldFog")
    hook.Remove("SetupSkyboxFog", "FogOfWarSkyboxFog")
end)