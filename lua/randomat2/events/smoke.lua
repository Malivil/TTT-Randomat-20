...
CreateConVar("randomat_smoke_charge_time", 30, FCVAR_NONE, "How many seconds it takes to charge the next attack", 10, 120)
CreateConVar("randomat_smoke_time", 5, FCVAR_NONE, "How many seconds the smoke lasts", 1, 30)
