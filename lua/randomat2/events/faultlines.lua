...
CreateConVar("randomat_faultline_min_delay", "20", {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "The minimum delay between quakes", 5, 120)
CreateConVar("randomat_faultline_severity_max", "10", {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "The maximum severity the earthquakes will have", 1, 10)
CreateConVar("randomat_faultline_aftershocks", "3", {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "The number of smaller quakes to happen after the peak", 0, 9)
