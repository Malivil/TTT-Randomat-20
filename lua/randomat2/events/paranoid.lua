...
CreateConVar("randomat_paranoid_timer_min", 15, FCVAR_NONE, "The minimum time before the sound should play", 1, 120)
CreateConVar("randomat_paranoid_timer_max", 30, FCVAR_NONE, "The maximum time before the sound should play", 1, 120)
CreateConVar("randomat_paranoid_shots_min", 2, FCVAR_NONE, "The minimum times the sound should play", 1, 10)
CreateConVar("randomat_paranoid_shots_max", 6, FCVAR_NONE, "The maximum times the sound should play", 1, 15)
CreateConVar("randomat_paranoid_volume", 125, FCVAR_NONE, "The volume the sound should play at", 75, 180)
CreateConVar("randomat_paranoid_blocklist", "weapon_pulserif,weapon_ttt_dislocator,tfa_jetgun", FCVAR_NONE, "The comma-separated list of weapon IDs to not use for sounds")
