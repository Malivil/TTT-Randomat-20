...
CreateConVar("randomat_blerg_respawntimer", 60, FCVAR_NONE, "Delay before dead players respawn", 5, 240)
CreateConVar("randomat_blerg_respawnlimit", 3, FCVAR_NONE, "The maximum number of times a player can respawn", 0, 10)
CreateConVar("randomat_blerg_weapondelay", 20, FCVAR_NONE, "Delay before respawned can use weapons", 5, 60)
