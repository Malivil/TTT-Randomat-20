...
CreateConVar("randomat_immunity_timer", 30, FCVAR_NONE, "The number of seconds the vote lasts", 10, 90)
CreateConVar("randomat_immunity_bullet", 0, FCVAR_NONE, "Whether bullet damage can be voted for")
CreateConVar("randomat_immunity_slashing", 0, FCVAR_NONE, "Whether slashing damage can be voted for")
