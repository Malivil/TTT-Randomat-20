...
local looseclips_keep_ammo = CreateConVar("randomat_looseclips_keep_ammo", 1, FCVAR_NONE, "Whether drained ammo is kept or destroyed")
local looseclips_affectbuymenu = CreateConVar("randomat_looseclips_affectbuymenu", 0, FCVAR_NONE, "Whether buy menu weapons lose ammo too")
