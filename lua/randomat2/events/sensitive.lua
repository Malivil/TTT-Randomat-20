...
CreateConVar("randomat_sensitive_change_interval", 15, FCVAR_NONE, "How often to change each player's sensitivity", 5, 60)
CreateConVar("randomat_sensitive_scale_min", 25, FCVAR_NONE, "The minimum sensitivity to use", 10, 100)
CreateConVar("randomat_sensitive_scale_max", 500, FCVAR_NONE, "The maximum sensitivity to use", 100, 1000)
