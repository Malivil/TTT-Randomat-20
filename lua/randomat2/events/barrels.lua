...
CreateConVar("randomat_barrels_count", 3, FCVAR_NONE, "Number of barrels spawned per person", 1, 5)
CreateConVar("randomat_barrels_range", 100, FCVAR_NONE, "Distance barrels spawn from the player", 50, 200)
CreateConVar("randomat_barrels_timer", 60, FCVAR_NONE, "Time between barrel spawns", 10, 120)
