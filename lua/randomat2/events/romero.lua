...
CreateConVar("randomat_romero_bonushealth", 100, FCVAR_NONE, "Extra health gained by the detective", 1, 200)
CreateConVar("randomat_romero_announce", 1, FCVAR_NONE, "Whether to announce when Mr. Romero dies")
