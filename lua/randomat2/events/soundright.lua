...
CreateConVar("randomat_soundright_blocklist", "weapon_pulserif,weapon_ttt_dislocator,tfa_jetgun", FCVAR_NONE, "The comma-separated list of weapon IDs to not use for sounds")
