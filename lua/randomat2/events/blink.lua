...
CreateConVar("randomat_blink_cap", 12, FCVAR_NONE, "Maximum number of Weeping Angels spawned", 0, 15)
CreateConVar("randomat_blink_delay", 0.5, FCVAR_NONE, "Delay before Weeping Angels are spawned", 0.1, 2.0)
