...
function EVENT:BeforeEventTrigger(ply, options, ...)
    ...
    self.Description = "Changes a random player to either " .. Randomat:GetRoleExtendedString(ROLE_JESTER):lower() .. " or " .. Randomat:GetRoleExtendedString(ROLE_TRAITOR):lower()
end
