...
CreateConVar("randomat_murder_pickups_ratio", 0.75, FCVAR_NONE, "Ratio of weapons required to get a revolver.", 1, 5)
CreateConVar("randomat_murder_highlight_gun", 1, FCVAR_NONE, "Whether to highlight dropped revolvers.")
CreateConVar("randomat_murder_knifespeed", 1.2, FCVAR_NONE, "Player move speed multiplier whilst knife is held.", 1, 2)
CreateConVar("randomat_murder_allow_shop", 0, FCVAR_NONE, "Whether to allow the shop to be used.")
