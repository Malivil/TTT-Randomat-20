...
CreateConVar("randomat_pumpyouup_buff", 0, FCVAR_NONE, "Which buff the target should get", 0, 3)
CreateConVar("randomat_pumpyouup_damage_scale", 1.1, FCVAR_NONE, "Target damage modifier (1.1 == 110% or a 10% bonus)", 0.05, 3)
CreateConVar("randomat_pumpyouup_speed_factor", 1.2, FCVAR_NONE, "Target speed modifier (1.1 == 110% or a 10% bonus)", 0.05, 3)
CreateConVar("randomat_pumpyouup_regen_timer", 0.66, FCVAR_NONE, "How often (in seconds) the target should be healed", 0, 5)
CreateConVar("randomat_pumpyouup_shield_factor", 0.25, FCVAR_NONE, "Percent less damage the target should take", 0.05, 1)
CreateConVar("randomat_pumpyouup_allow_self_vote", 0, FCVAR_NONE, "Whether to allow players to vote for themselves")
