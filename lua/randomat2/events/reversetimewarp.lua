...
CreateConVar("randomat_reversetimewarp_scale", 15, {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "The percentage the speed should decrease", 1, 200)
CreateConVar("randomat_reversetimewarp_scale_min", 0.15, {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "The minimum scale the speed should decrease to", 0.1, 0.9)
CreateConVar("randomat_reversetimewarp_timer", 15, {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "How often (in seconds) the speed will be decreased", 1, 60)
