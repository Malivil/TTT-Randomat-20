...
CreateConVar("randomat_huntingseason_delay", 5, FCVAR_NONE, "The delay before the player changes", 1, 60)
CreateConVar("randomat_huntingseason_show_name", 1, FCVAR_NONE, "Whether to show the target player's name in the event title", 1, 60)
