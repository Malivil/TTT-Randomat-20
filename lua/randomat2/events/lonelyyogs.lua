...
CreateConVar("randomat_lonelyyogs_distance", 200, FCVAR_NONE, "The minimum distance allowed between players", 25, 1000)
CreateConVar("randomat_lonelyyogs_interval", 2, FCVAR_NONE, "The number of seconds between discombob blasts", 1, 600)
