...
CreateConVar("randomat_specbuff_charge_time", 60, FCVAR_ARCHIVE, "How many seconds it takes to charge to full power", 10, 120)
CreateConVar("randomat_specbuff_heal_power", 75, FCVAR_ARCHIVE, "The amount of power to heal the target", 1, 100)
CreateConVar("randomat_specbuff_heal_amount", 10, FCVAR_ARCHIVE, "The amount of to heal the target", 1, 100)
CreateConVar("randomat_specbuff_fast_power", 35, FCVAR_ARCHIVE, "The amount of power to make the target faster", 1, 100)
CreateConVar("randomat_specbuff_fast_factor", 1.3, FCVAR_ARCHIVE, "The speed factor for target when fast", 1.1, 2)
CreateConVar("randomat_specbuff_fast_timer", 3, FCVAR_ARCHIVE, "How long the effect lasts", 1, 60)
CreateConVar("randomat_specbuff_slow_power", 35, FCVAR_ARCHIVE, "The amount of power to slow the target", 1, 100)
CreateConVar("randomat_specbuff_slow_factor", 0.7, FCVAR_ARCHIVE, "The speed factor for target when slow", 0.1, 0.9)
CreateConVar("randomat_specbuff_slow_timer", 3, FCVAR_ARCHIVE, "How long the effect lasts", 1, 60)
CreateConVar("randomat_specbuff_slap_power", 75, FCVAR_ARCHIVE, "The amount of power to slap the target", 1, 100)
CreateConVar("randomat_specbuff_slap_force", 500, FCVAR_ARCHIVE, "How hard to slap the target", 250, 1000)
