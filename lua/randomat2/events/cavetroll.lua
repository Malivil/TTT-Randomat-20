...
CreateConVar("randomat_cavetroll_troll_scale", 1.5, FCVAR_NONE, "The scale factor to use for the troll", 1.1, 3.0)
CreateConVar("randomat_cavetroll_troll_damage", 50, FCVAR_NONE, "How much damage the club should do", 0, 100)
CreateConVar("randomat_cavetroll_troll_health", 150, FCVAR_NONE, "The amount of health the troll should have", 100, 300)
CreateConVar("randomat_cavetroll_hobbit_scale", 0.5, FCVAR_NONE, "The scale factor to use for the hobbits", 0.1, 0.9)
CreateConVar("randomat_cavetroll_hobbit_pct", 0.34, FCVAR_NONE, "The percent of non-traitors to be hobbits", 0, 0.5)
CreateConVar("randomat_cavetroll_hobbit_damage", 20, FCVAR_NONE, "How much damage the swords should do", 1, 100)
