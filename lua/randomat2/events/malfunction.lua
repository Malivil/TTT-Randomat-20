...
CreateConVar("randomat_malfunction_upper", 15, FCVAR_NONE, "The upper limit for the random timer", 2, 60)
CreateConVar("randomat_malfunction_lower", 1, FCVAR_NONE, "The lower limit for the random timer", 1, 60)
CreateConVar("randomat_malfunction_affectall", 0, FCVAR_NONE, "Set to 1 for the event to affect everyone at once")
CreateConVar("randomat_malfunction_duration", 0.5, FCVAR_NONE, "Duration of gun malfunction (set to 0 for 1 shot)", 0.0, 3.0)
