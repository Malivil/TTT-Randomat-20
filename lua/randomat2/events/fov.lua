...
CreateConVar("randomat_fov_scale", 1.5, FCVAR_NONE, "Scale of the FOV increase", 1.1, 2.0)
CreateConVar("randomat_fov_scale_ironsight", 1.0, FCVAR_NONE, "Scale of the FOV increase when ironsighted", 0.8, 2.0)
