...
CreateConVar("randomat_redlight_mindelay", 3, FCVAR_NONE, "Minimum time for each phase", 1, 30)
CreateConVar("randomat_redlight_maxdelay", 10, FCVAR_NONE, "Maximum time for each phase", 1, 30)
CreateConVar("randomat_redlight_damage", 3, FCVAR_NONE, "Amount of damage a player takes per second", 1, 10)
