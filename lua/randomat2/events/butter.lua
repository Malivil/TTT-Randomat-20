...
CreateConVar("randomat_butter_timer", 10, FCVAR_NONE, "The time between each weapon drop.", 5, 60)
CreateConVar("randomat_butter_affectall", 0, FCVAR_NONE, "Whether to affect everyone or just a single random player.")
