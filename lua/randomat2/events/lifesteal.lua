...
CreateConVar("randomat_lifesteal_health", 25, FCVAR_NONE, "The health gained per kill", 1, 100)
CreateConVar("randomat_lifesteal_cap", 0, FCVAR_NONE, "The max health a player can get (0 to disable)", 0, 200)
