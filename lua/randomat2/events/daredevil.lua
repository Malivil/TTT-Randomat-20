...
local min_damage_scale = CreateConVar("randomat_daredevil_min_damage_scale", 1, {FCVAR_NOTIFY, FCVAR_ARCHIVE}, "", 0, 1)
local max_damage_scale = CreateConVar("randomat_daredevil_max_damage_scale", 2.5, {FCVAR_NOTIFY, FCVAR_ARCHIVE}, "", 1.1, 5)
